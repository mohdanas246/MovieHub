...
use Project\Controller\CustomerController;

if (isset($_POST['firstName']) && isset($_POST['lastName']) && isset($_POST['email']) && isset($_POST['password'])) {
    $customerController = new CustomerController();

    try {
        $customerController->insertValue($_POST['firstName'], $_POST['lastName'], $_POST['email'], $_POST['password']);
    } catch (\Exception $e) {
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="table-responsive">
                    ...
                    $customerrModel = new CustomerModel;
                    $options = $customerrModel->getAllCustomer();
                    ?>
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    <td><?php echo $option['customer_id']; ?></td>
                                    <td><?php echo $option['first_name']; ?></td>
                                    <td><?php echo $option['last_name']; ?></td>
