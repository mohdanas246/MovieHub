...
use Project\Controller\LanguageController;

if (isset($_POST['language'])) {
  $languageController = new LanguageController();
  try {
    $languageController->insertValue($_POST['language']);
  } catch (\Exception $e) {
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="table-responsive">
          ...
          $options = $languageModel->getAllLanguage();
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  <td><?php echo $option['language_id']; ?></td>
                  <td><?php echo $option['language']; ?></td>
                </tr>
