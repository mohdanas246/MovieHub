...
use Project\Controller\CategoryController;

if (isset($_POST['name'])) {
  $categoryController = new CategoryController();
  try {
    $categoryController->insertValue($_POST['name']);
  } catch (\Exception $e) {
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="table-responsive">
          ...
          $categoryLangage = new CategoryModel;

          $options = $categoryLangage->getAllCategories();
          ?>
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  ...
                  <td><?php echo $option['category_name']; ?></td>
                </tr>
