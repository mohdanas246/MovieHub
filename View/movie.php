...
use Project\Controller\MovieController;


if (
    isset($_POST['tittle']) && isset($_POST['category']) && isset($_POST['relaeseYear']) && isset($_POST['releaseCountry']) && isset($_POST['shortDesc'])
    && isset($_POST['boxOffice']) && isset($_POST['longDesc']) && isset($_POST['duration']) && isset($_POST['production'])
) {
    $movieController = new MovieController();


    try {
        $movieController->insertValue(
            $_POST['tittle'],
            $_POST['category'],
            $_POST['relaeseYear'],
            $_POST['releaseCountry'],
            $_POST['shortDesc'],
            $_POST['boxOffice'],
            $_POST['longDesc'],
            $_POST['duration'],
...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="index.html"><img class="navbar-brand mb-0 h1" src="images/logo1.jpg" width="100" height="80" /></a>
        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="movie.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="movieCast.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="table-responsive">
                    ...
                    $moviecastModel = new MovieModel;
                    $options = $moviecastModel->getAllMovie();
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    <td><?php echo $option['movie_id']; ?></td>
                                    <td><?php echo $option['tittle']; ?></td>
                                    <td><?php echo $option['category_id']; ?></td>
                                    <td><?php echo $option['release_year']; ?></td>
                                    <td><?php echo $option['release_country']; ?></td>
                                    <td><?php echo $option['short_desc']; ?></td>
                                    <td><?php echo $option['box_office']; ?></td>
                                    <td><?php echo $option['long_desc']; ?></td>
                                    <td><?php echo $option['duration']; ?></td>
                                    <td><?php echo $option['production']; ?></td>
                                </tr>
    ...
    <div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="">
                        <div class="mb-3">
                            <label for="tittle" class="form-label">Movie Tittle</label>
                            <input type="text" name="tittle" class="form-control" aria-describedby="emailHelp" />
                        </div>
                        ...
                        <div class="md-3">
                            ...
                            <select id="inputState" name="category" class="form-control">
                                ...
                                foreach ($options as $option) {
                                ?>
                                    <option value="<?= $option['category_id'] ?>"> <?php echo $option['category_name']; ?> </option>
                        ...
                        <div class="mb-3">
                            <label for="relaeseYear" class="form-label">Release Year</label>
                            <input type="number" name="relaeseYear" class="form-control" aria-describedby="emailHelp" />
                        </div>
                        <div class="mb-3">
                            <label for="releaseCountry" class="form-label">Release Country</label>
                            <input type="text" name="releaseCountry" class="form-control" aria-describedby="emailHelp" />
                        </div>
                        <div class="mb-3">
                            <label for="shortDesc" class="form-label">Short Desc</label>
                            <input type="text" name="shortDesc" class="form-control" aria-describedby="emailHelp" />
                        </div>
                        <div class="mb-3">
                            <label for="boxOffice" class="form-label">Box Office</label>
                            <input type="text" name="boxOffice" class="form-control" aria-describedby="emailHelp" />
                        </div>
                        <div class="mb-3">
                            <label for="longDesc" class="form-label">Long Desc</label>
                            <textarea id="w3review" name="longDesc" rows="4" cols="45"></textarea>
                        </div>
                        ...
                        <div class="md-3">
                            ...
                            <button type="submit" class="btn btn-primary" value="insertValue">Save</button>
                    </form>
                </div>
            ...
            </div>Duplicate entry 'a' for key 'customer.email_UNIQUE'
    ...
    <script src="https://kit.fontawesome.com/7a769d1122.js" crossorigin="anonymous"></script>
</body>
