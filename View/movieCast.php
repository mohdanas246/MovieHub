...
require_once(__DIR__ . "/../Controller//MovieCastController.php");

use Project\Controller\MovieCastController;

if (isset($_POST['castName']) && isset($_POST['shortDesc']) && isset($_POST['longDesc']) && isset($_POST['height']) && isset($_POST['dob'])) {
    $moviecastController = new MovieCastController();

    try {
        $moviecastController->insertValue($_POST['castName'], $_POST['shortDesc'], $_POST['longDesc'], $_POST['height'], $_POST['dob']);
    } catch (\Exception $e) {
        ...
        <div class="row">
            ...
            <div class="mx-2">
                ...
                <div class="table-responsive">
                    ...
                    $moviecastModel = new MovieCastModel;
                    $options = $moviecastModel->getAllMovieCast();
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    <td><?php echo $option['movie_cast_id']; ?></td>
                                    <td><?php echo $option['cast_name']; ?></td>
                                    <td><?php echo $option['short_desc']; ?></td>
                                    <td><?php echo $option['long_desc']; ?></td>
                                    <td><?php echo $option['height']; ?></td>
                                    <td><?php echo $option['DOB']; ?></td>
                                </tr>
                    ...
                    <div class="modal-body">
                        <form method="POST" action="">
                            <div class="mb-3">
                                ...
                                <input type="text" name="castName" class="form-control" aria-describedby="emailHelp" />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="longDesc" class="form-control" aria-describedby="emailHelp" />
                            </div>
                            <div class="mb-3">
                                <label for="height" class="form-label">Height</label>
                                <input type="text" name="height" class="form-control" aria-describedby="emailHelp" />
                            </div>
                            <div class="mb-3">
                                <label for="dob" class="form-label">DOB</label>
                                <input type="date" name="dob" class="form-control" aria-describedby="emailHelp" />
                            </div>
